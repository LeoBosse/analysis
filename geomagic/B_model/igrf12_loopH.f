...
c
      ...
      double precision theta_phi_H(Nangle,2)
      double precision Bxyz(Nangle,3)
...
C
     ...
     1    GO TO 205
      ...
      ELSE
       ...
       open(1100,file = './theta_phi_H.dat', form='formatted')
...
!      READ (*,'(A)') NAME
      open(1122,file='./Bxyz_H_igrf.dat')
      do jj=1,Nangle
       XLT = (pi/2-theta_phi_H(jj,1))*180/pi
       XLN = theta_phi_H(jj,2)*180/pi
      CLT = 90.0 - XLT
...
C
      ...
      DF = (H*DH + Z*DZ)/F
       ...
       write(1122,*) theta_phi_H(jj,1), theta_phi_H(jj,2), X,Y,Z
