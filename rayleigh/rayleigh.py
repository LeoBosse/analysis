		...
		for t in range(self.world.sky_map.Nt):
			for ie_pc in range(self.world.Nb_e_pc):
				for ia_pc in range(self.world.Nb_a_pc):
					...
					print(t, self.world.a_pc_list[ia_pc]*RtoD, self.world.e_pc_list[ie_pc]*RtoD, self.I_list[t, ie_pc, ia_pc], self.DoLP_list[t, ie_pc, ia_pc], self.AoRD_list[t, ie_pc, ia_pc] * RtoD)
