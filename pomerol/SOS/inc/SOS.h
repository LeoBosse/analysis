...
C---------------------------------------------------------------
#define SOS_AER_SR_SF		"IRefrac_SR"
#define SOS_AER_LR_SF		"IRefrac_LR"
#define SOS_AER_SU_SF		"IRefrac_SU"
#define SOS_AER_LU_SF		"IRefrac_LU"
#define SOS_AER_OM_SF		"IRefrac_OM"
